    angular.module('mainApp').factory('authService', ['$http', '$q', 'localStorageService', 'ngAuthSettings', function ($http, $q, localStorageService, ngAuthSettings) {
        ...
        var _saveRegistration = function (registration) {
            ...
            return $http.post(serviceBase + 'user/index', registration).then(function (response) {
                return response;
            });
        };
        ...
        var _login = function (loginData) {
            ...
            $http.post(serviceBase + 'token', data, { headers: { 'Content-Type': 'application/x-www-form-urlencoded' } }).success(function (response) {
                alert(loginData.useRefreshTokens)
                if (loginData.useRefreshTokens) {
