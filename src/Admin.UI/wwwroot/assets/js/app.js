...
(function () {
    ...
    app.controller('AddressBookController', function (addressModels, $scope, $http, $filter, virtualDir, $cookieStore) {
        $cookieStore.put("Name", "Shashi");
...
/*
 AngularJS v1.5.0-build.4439+sha.e4e5677
